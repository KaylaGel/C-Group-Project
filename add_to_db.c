...
/*
  ...
  * Could use for the database after it has been saved and before it is loaded    * Could possibly ask user for a database password that is used as the xor key to save and load the database
