...
OBJECTS = main.o menus.o data_validation.o user_input.o accounts.o struct_factory.o print.o encrypt.o display.o search.o edit_event.o event_factory.o user_factory.o linked_list.o
